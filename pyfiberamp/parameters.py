...
ER_UPPER_STATE_LIFETIME = 9e-3  # s
c = 299_792_458
h = 6.62607e-34
...
ER_ABSORPTION_CS_FILE = os.path.join(spectrum_folder, 'erbium absorption cross section.txt')
ER_EMISSION_CS_FILE = os.path.join(spectrum_folder, 'erbium emission cross section.txt')